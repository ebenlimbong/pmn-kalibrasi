                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-1 border rounded-3 d-flex gap-1 gap-sm-2 flex-nowrap overflow-hidden" style="background-color: #f8fafc;">
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_edit_baik" value="baik" <?= (empty($instrumen->kondisi) || strtolower($instrumen->kondisi) === 'baik') ? 'checked' : '' ?> required>
                                    <label class="btn btn-outline-success border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_edit_baik" style="font-size: 0.8rem;">
                                        <i class="bi bi-check-circle-fill"></i> Baik
                                    </label>
                                </div>
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_edit_rusak" value="rusak" <?= (!empty($instrumen->kondisi) && strtolower($instrumen->kondisi) === 'rusak') ? 'checked' : '' ?>>
                                    <label class="btn btn-outline-danger border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_edit_rusak" style="font-size: 0.8rem;">
                                        <i class="bi bi-x-circle-fill"></i> Rusak
                                    </label>
                                </div>
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_edit_perbaikan" value="perbaikan" <?= (!empty($instrumen->kondisi) && strtolower($instrumen->kondisi) === 'perbaikan') ? 'checked' : '' ?>>
                                    <label class="btn btn-outline-warning border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_edit_perbaikan" style="font-size: 0.8rem;">
