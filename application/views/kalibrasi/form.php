<div class="d-flex justify-content-between align-items-center mb-4 mt-3">
    <h6 class="text-uppercase fw-bold text-secondary mb-0" style="letter-spacing: 0.5px;">TAMBAH INSTRUMEN</h6>
</div>

<div class="row">
    <div class="col-md-10 mx-auto">
        <form action="<?= base_url('kalibrasi/store') ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="nama_instrumen" required placeholder="Digital Caliper">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label text-dark fw-medium">Seksi Pemakai</label>
                            <input type="text" class="form-control" name="seksi_pemakai" placeholder="SQA">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" name="interval_nilai[]" id="interval-nilai-input" placeholder="1-10">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" name="ketelitian_nilai[]" id="ketelitian-nilai-input" placeholder="0.01">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="model_tipe" placeholder="DMX-411H">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="kegunaan" placeholder="Mengukur panjang">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" name="batas_nilai[]" id="batas-nilai-input" placeholder="0.05">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-1 border rounded-3 d-flex gap-1 gap-sm-2 flex-nowrap overflow-hidden" style="background-color: #f8fafc;">
                                <div class="flex-fill text-center">
                                    ...
                                    <label class="btn btn-outline-success border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_baik" style="font-size: 0.8rem;">
                                        <i class="bi bi-check-circle-fill"></i> Baik
                                    </label>
                                </div>
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_rusak" value="rusak">
                                    <label class="btn btn-outline-danger border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_rusak" style="font-size: 0.8rem;">
                                        <i class="bi bi-x-circle-fill"></i> Rusak
                                    </label>
                                </div>
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_perbaikan" value="perbaikan">
                                    <label class="btn btn-outline-warning border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_perbaikan" style="font-size: 0.8rem;">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="badan_kalibrasi" placeholder="PT Global">
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label text-dark fw-medium">Nomor Sertifikat</label>
                            <input type="text" class="form-control" name="nomor_sertifikat" placeholder="24.1416.B">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-dark fw-medium">File Sertifikat (PDF/Image)</label>
