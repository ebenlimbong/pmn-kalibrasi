                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-1 border rounded-3 d-flex gap-1 gap-sm-2 flex-nowrap overflow-hidden" style="background-color: #f8fafc;">
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_baik_int" value="baik" checked required>
                                    <label class="btn btn-outline-success border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_baik_int" style="font-size: 0.8rem;">
                                        <i class="bi bi-check-circle-fill"></i> Baik
                                    </label>
                                </div>
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_rusak_int" value="rusak">
                                    <label class="btn btn-outline-danger border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_rusak_int" style="font-size: 0.8rem;">
                                        <i class="bi bi-x-circle-fill"></i> Rusak
                                    </label>
                                </div>
                                <div class="flex-fill text-center">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_perbaikan_int" value="perbaikan">
                                    <label class="btn btn-outline-warning border-0 w-100 py-1.5 px-1 px-sm-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1 text-nowrap" for="kondisi_perbaikan_int" style="font-size: 0.8rem;">
