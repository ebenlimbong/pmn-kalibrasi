                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-1 border rounded-3 d-flex gap-2" style="background-color: #f8fafc;">
                                <div class="flex-fill">
                                    ...
                                    <label class="btn btn-outline-success border-0 w-100 py-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1" for="kondisi_baik_int" style="font-size: 0.88rem;">
                                        <i class="bi bi-check-circle-fill"></i> Baik
                                    </label>
                                </div>
                                <div class="flex-fill">
                                    <input type="radio" class="btn-check" name="kondisi" id="kondisi_rusak_int" value="rusak">
                                    <label class="btn btn-outline-danger border-0 w-100 py-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1" for="kondisi_rusak_int" style="font-size: 0.88rem;">
                                ...
                                <div class="flex-fill">
                                    ...
                                    <label class="btn btn-outline-warning border-0 w-100 py-2 rounded-3 fw-semibold d-flex align-items-center justify-content-center gap-1" for="kondisi_perbaikan_int" style="font-size: 0.88rem;">
