<div class="d-flex justify-content-between align-items-center mb-4 mt-3">
    <h6 class="text-uppercase fw-bold text-secondary mb-0" style="letter-spacing: 0.5px;">DETAIL INSTRUMEN STANDAR KERJA</h6>
</div>
                            ...
                            <?php else : ?>
                                <?php foreach($riwayat as $r) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="<?= base_url('kalibrasi-internal/deleteRiwayat/' . $r->id) ?>" method="post" onsubmit="return confirm('Apakah Anda yakin ingin menghapus riwayat ini?');">
                                                <?= csrf_field() ?>
...
<div class="modal fade" id="updateKalibrasiModal" tabindex="-1" aria-labelledby="updateKalibrasiModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content rounded-4 border-0 shadow">
      ...
      <form action="<?= base_url('kalibrasi-internal/storeRiwayat/' . $instrumen->id) ?>" method="post" enctype="multipart/form-data">
          <?= csrf_field() ?>
          <div class="modal-body">
              ...
              <div class="mb-3">
                  <label class="form-label text-muted fw-medium">Lampiran</label>
